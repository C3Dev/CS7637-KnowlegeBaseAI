...
public class Agent {
    ...
    public int Solve(RavensProblem problem) {
     ...
     if(problem.getName().contains("Basic Problem B-02")){
       ...
       System.out.println("Initalizing " + problem.getName());
    ...
    // remove and change after every write answer:
       ...
       System.out.println("Elapsed Time " + passedTimeInSeconds + " seconds" );
